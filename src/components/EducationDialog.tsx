        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 p-4 rounded-lg border bg-card">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-1">Advanced Study MS in ECE</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 p-4 rounded-lg border bg-card">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-1">Riccio College of Engineering</p>
              <p className="text-sm">Bachelor of Science in Computer Engineering</p>
